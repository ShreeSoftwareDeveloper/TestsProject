...
builder.Services.AddDbContext<TestForInterviewContext>(option => option.UseSqlServer(builder.Configuration.GetConnectionString("DBCON")));
builder.Services.AddScoped<IStudentInterface, StudentService>();
builder.Services.AddScoped<ITeacherInterface, TeacherService>();
builder.Services.AddScoped<ISubjectInterface, SubjectService>();
